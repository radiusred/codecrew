...
**Status: design phase.** The protocol is specified; the CLI does not exist
yet. This repository is CodeCrew's own hub, and CodeCrew is being built with
CodeCrew, starting with the protocol run by hand.
